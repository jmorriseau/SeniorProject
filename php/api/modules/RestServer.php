...
class RestServer {
    ...
    private function setServer_data() {
        ...
        switch ( json_last_error() ) {
                ...
                { //data UTF-8 compliant
                  //tell client to receive JSON data and send
                }
                break;
    ...
    //Sets the verb based on what input method was selected in the drop down menu
    ...
    //construct used at the initialization of the RestServer. Contains the rest arguments call as well as the location of
