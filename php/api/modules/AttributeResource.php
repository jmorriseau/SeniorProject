...
class AttributeResource implements IRestModel
{
    ...
    public function get($id)
    {
        ...
        return $this->db->sql("SELECT Attributes.attributes_id, Attributes.attributes_name, Attribute_Types.attribute_type_name 
                                FROM Attributes, Attribute_Types WHERE Attributes.attribute_type_id = Attribute_Types.attribute_type_id 
    ...
    public function post($data)
    {
        ...
        //return 'yay';
        try {
            $this->db->sql("INSERT INTO Attributes (attribute_type_id, attributes_name)
             VALUES(
    ...
    public function dataCheck($data) {
        ...
        if ($data['attribute_type_id'] === '' ){
            $errors[] = 'Attribute Type ID Required';
        }
        if ($data['attributes_name'] === '' ){
            $errors[] = 'Attribute Name Required';
        }
        else{
            return true;
        }
